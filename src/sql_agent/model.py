...
class SQLAgent:
    ...
    def _update_context(self, new_context: str) -> str:
        try:
            ...
            self.conversation_history = context_dict.get("conversation_history", self.conversation_history)
            self.last_query_result = context_dict.get("last_query_result", self.last_query_result)
